...
import type { EnhancementMode as _EnhancementMode, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async finalizeUpload(arg0: string, arg1: EnhancementMode): Promise<{
        ok?: {
            enhancedImage: Uint8Array;
            imageId: string;
        };
        ...
        if (this.processError) {
            try {
                const result = await this.actor.finalizeUpload(arg0, to_candid_EnhancementMode_n8(this._uploadFile, this._downloadFile, arg1));
    ...
    async getAllImageIds(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllImageIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImageRaw(arg0: string): Promise<Uint8Array> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageRaw(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initUpload(arg0: bigint, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.initUpload(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadChunk(arg0: string, arg1: bigint, arg2: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ok: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.ok)),
        err: value.err
    };
}
...
function to_candid_EnhancementMode_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EnhancementMode): _EnhancementMode {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EnhancementMode): {
    anime: null;
} | {
    standard: null;
} {
    return value == EnhancementMode.anime ? {
        anime: null
    } : value == EnhancementMode.standard ? {
        standard: null
    } : value;
}
