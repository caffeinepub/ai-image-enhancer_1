...
import { Heart, RefreshCw, Sparkles, Star, Zap } from "lucide-react";
...
import { type UploadProgress, useProcessImage } from "./hooks/useQueries";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-8">
        ...
        <div className="mb-5 animate-fade-in">
          ...
          <div className="inline-flex rounded-xl border border-charcoal-border bg-charcoal-card p-1 gap-1">
            ...
            <button
              type="button"
              onClick={() =>
                !isProcessing && setEnhancementMode(EnhancementMode.standard)
              }
              disabled={isProcessing}
              aria-pressed={enhancementMode === EnhancementMode.standard}
              data-ocid="enhancement.standard.toggle"
              className={[
            ...
            <button
              type="button"
              onClick={() =>
                !isProcessing && setEnhancementMode(EnhancementMode.anime)
              }
              disabled={isProcessing}
              aria-pressed={enhancementMode === EnhancementMode.anime}
              data-ocid="enhancement.anime.toggle"
              className={[
                "flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold font-display transition-all duration-200",
                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60",
                isProcessing
        ...
        <div className="card-gradient card-gradient-hover rounded-2xl p-6 md:p-8 shadow-card-depth mb-6 transition-all duration-300">
          ...
          {(appState === "ready" || appState === "error") && (
            <div className="mt-5 flex items-center gap-3 animate-fade-in">
              <Button
                ...
                size="lg"
                data-ocid="enhance.primary_button"
                className="
              ...
              <Button
                ...
                variant="ghost"
                size="lg"
                data-ocid="enhance.cancel_button"
          ...
          {appState === "done" && (
            <div
              className="mt-5 flex items-center gap-3 animate-fade-in"
              data-ocid="enhance.success_state"
            >
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                data-ocid="enhance.secondary_button"
        ...
        {/* Comparison view */}
        {(isProcessing || appState === "done" || appState === "error") &&
          originalUrl && (
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono text-primary/60 font-bold">
                    {step}
                  </span>
                </div>
                <div>
      ...
      <footer className="border-t border-charcoal-border mt-auto py-6">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground">
          <span>
            © {new Date().getFullYear()} PixelBoost. All rights reserved.
          </span>
